...
public class OneNTSharedResBean extends SNMPRunBean implements Observer {
    ...
    private final static String svShareName = "1.3.6.1.4.1.77.1.2.27.1.1";
    private final static String svSharePath = "1.3.6.1.4.1.77.1.2.27.1.2";
    private final static String svShareComment = "1.3.6.1.4.1.77.1.2.27.1.3";
